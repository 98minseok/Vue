            ...
            <form @submit.prevent="onSubmit">
                ...
                <input
                    ...
                    <div v-if="!is_login_form">
                        <small class="text-danger" v-if="invalid == 'diff_password'">
                            새로운 비밀번호가 다릅니다.
                        </small>
                        <input
                            type="password"
                            ...
                            class="form-control"
                            :class = "{'is-invalid': invalid == 'diff_password'}"
                    ...
                    <div class="checkbox mb-3" v-if="is_login_form">
                            <input type="checkbox" v-model="stay"> 로그인 유지
                    </div>
                    <button class="btn btn-lg btn-primary btn-block" type="submit">
                        {{ is_login_form ? '입장하기' : '변경하기' }}
                    </button>
    ...
    setup(props,context){
        ...
        const onSubmit = (evt) =>{
            ...
            if (is_login_form.value) {
                login(email.value,password.value,stay.value)
                .then((data) => {
